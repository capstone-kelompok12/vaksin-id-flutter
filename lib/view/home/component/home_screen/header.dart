  ...
  Widget build(BuildContext context) {
    return Consumer<HomeViewModel>(
      builder: (context, value, _) => Container(
          ...
          padding:
              const EdgeInsets.only(top: 41, bottom: 16, left: 16, right: 16),
          decoration:
              const BoxDecoration(color: Color.fromRGBO(0, 109, 57, 0.12)),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          padding: EdgeInsets.only(
                              bottom: value.paddingBottomHeading),
                          child: SizedBox(
                            width: double.infinity,
                            height: 87,
                            child: Row(
