                  ...
                  value.currentLatLng == null
                    ...
                    : GoogleMap(
                        ...
                        onTap: (argument) {
                          ...
                          if (value.selectedMarker != 0) {
                            setState(() {
                              value.markers[value.selectedMarker] =
                                  value.markers[value.selectedMarker].copyWith(
                                      iconParam: BitmapDescriptor.fromBytes(value.markerIcon!));
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: IconButton(
                            onPressed: () {
                              value.gmController?.animateCamera(CameraUpdate.newCameraPosition(
                                CameraPosition(
